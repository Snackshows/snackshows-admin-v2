...
import { useGetEmployeeByIdQuery } from "../api/staffManagement/staffManagement.endpoint"

const UserDetailsPage = () => {
  const { id } = useParams<{ id: string }>()
  const navigate = useNavigate()
  const { data: user, isLoading } = useGetEmployeeByIdQuery(id || "")
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{user.role === 1 ? "Admin" : user.role === 2 ? "Staff" : "User"}</p>
                </div>
