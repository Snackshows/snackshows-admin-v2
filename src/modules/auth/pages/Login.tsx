...
import { FieldGroup, Field, FieldSeparator, FieldDescription, FieldLabel, FieldError } from '@/components/ui/field'
                                    ...
                                    <Controller
                                        ...
                                        render={({ field, fieldState }) => (
                                            <Field data-invalid={fieldState.invalid}>
                                                ...
                                                <Input {...field} id={field.name} placeholder="m@example.com" aria-invalid={fieldState.invalid} />
